...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    myswift *swiftObject =[[myswift alloc] init];
    
    [swiftObject run];
    
    //launch screen TimeInterval.
    [NSThread sleepForTimeInterval:2];
    
    //Navigation bar tintcolor,shadow etc.
    [[UINavigationBar appearance] setBarTintColor:[UIColor colorWithRed: 0.204 green: 0.239 blue: 0.498 alpha: 1]];
